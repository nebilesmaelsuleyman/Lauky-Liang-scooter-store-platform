...
export default function EditProductPage({ params }: { params: { id: string } }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Only send fields that are filled (optional)
      Object.entries(formData).forEach(([key, value]) => {
        if (value !== "" && value !== null && value !== undefined) {
          if (["price", "compareAtPrice", "discount"].includes(key)) {
      ...
      if (specifications.length > 0) {
        productData.specifications = specifications.reduce((acc, spec) => {
  ...
  if (loading) return <p className="text-center text-muted-foreground">Loading product...</p>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Input
                  type="number"
                  placeholder={formData.compareAtPrice || "Compare At Price"}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <Input
                  type="number"
                  placeholder={formData.stock || "Stock Quantity"}
