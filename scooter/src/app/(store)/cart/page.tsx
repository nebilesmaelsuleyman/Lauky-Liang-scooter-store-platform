                        ...
                        <div className="flex-1">
                          <div className="flex justify-between">
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground mt-1">د.إ{item.price} each</p>
                            </div>
                          ...
                          <div className="flex items-center justify-between mt-4">
                            ...
                            <div className="text-right">
                              <p className="font-bold text-lg">د.إ{(item.price * item.quantity).toFixed(2)}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold text-xl">د.إ{total.toFixed(2)}</span>
                      </div>
                    </div>
                    ...
                    {subtotal < 1000 && subtotal > 0 && (
                      <p className="text-xs text-muted-foreground text-center mt-4">
                        Add د.إ{(1000 - subtotal).toFixed(2)} more for free shipping
                      </p>
                    )}
                  </CardContent>
                </Card>
