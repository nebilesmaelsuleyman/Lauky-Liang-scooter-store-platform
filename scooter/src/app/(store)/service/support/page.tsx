  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
    ...
    <div className="p-4 bg-white/5 rounded-lg border border-white/10">
      ...
      <p className="text-gray-200">China</p>
        ...
        {/* Contact Section */}
        <section className="space-y-6">
          <h2 className="text-4xl font-bold text-green-400">Ask a Question / Technical Support</h2>
          <p className="text-gray-200">
            Tap the chat bubble to start a conversation, or send us an email at{' '}
            <a href="mailto:support@luckyliangev.com" className="text-green-400 underline">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <a
              href="#"
              className="bg-green-600 hover:bg-green-500 text-black font-semibold px-6 py-3 rounded-lg text-center transition"
            >
              Live Chat
            </a>
            <a
        ...
        <section className="space-y-4">
          <h2 className="text-4xl font-bold text-green-400">Share Your Story</h2>
