  ...
  return (
    <div className="min-h-screen bg-[#0D1F3C] text-white">
      ...
      <header className="bg-[#0B1A30] py-6 shadow-md">
        <div className="container mx-auto px-6 md:px-10 flex justify-between items-center">
          ...
          <nav className="space-x-4">
            <Link href="/support" className="text-green-400 font-semibold">
              Support
            </Link>
          </nav>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-green-400 mb-2">1) Overview</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-green-400 mb-2">2) Online Store Terms</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-green-400 mb-2">3) General Conditions</h2>
          <ul className="list-disc list-inside space-y-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-green-400 mb-2">4) Accuracy of Information</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-green-400 mb-2">5) Modifications to Service and Prices</h2>
          <ul className="list-disc list-inside space-y-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-green-400 mb-2">6) Products or Services</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-green-400 mb-2">19) Governing Law</h2>
          <p>These Terms are governed by the laws of the United Arab Emirates.</p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold text-green-400 mb-2">21) Contact Information</h2>
