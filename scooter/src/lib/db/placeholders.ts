...
export const mockCategories: Category[] = [
  {
    ...
    image: "/modern-electric-scooter.png",
    isActive: true,
  ...
  },
  {
    ...
    image: "/commuter-electric-scooter-city.jpg",
    isActive: true,
    createdAt: new Date("2024-01-01"),
    updatedAt: new Date("2024-01-01"),
  },
  {
    ...
    image: "/fast-performance-electric-scooter.jpg",
    isActive: true,
    createdAt: new Date("2024-01-01"),
    updatedAt: new Date("2024-01-01"),
  },
  {
    ...
    image: "/off-road-electric-scooter-terrain.jpg",
    isActive: true,
    createdAt: new Date("2024-01-01"),
    updatedAt: new Date("2024-01-01"),
  },
...
export const mockProducts: Product[] = [
  {
    ...
    price: 899,
    compareAtPrice: 1099,
    images: ["/sleek-black-electric-scooter-urban.jpg", "/electric-scooter-side-view.jpg"],
    category: "cat_2",
    specifications: {
      maxSpeed: "25 mph",
      range: "40 miles",
  ...
  },
  {
    ...
    price: 1499,
    compareAtPrice: 1799,
    images: ["/red-performance-electric-scooter-fast.jpg", "/sport-electric-scooter.jpg"],
    category: "cat_3",
    specifications: {
      maxSpeed: "35 mph",
      range: "35 miles",
  ...
  },
  {
    ...
    price: 499,
    compareAtPrice: 599,
    images: ["/white-compact-electric-scooter-affordable.jpg", "/lightweight-electric-scooter.png"],
    category: "cat_2",
    specifications: {
      maxSpeed: "18 mph",
      range: "20 miles",
  ...
  },
  {
    ...
    price: 1799,
    compareAtPrice: 2099,
    images: ["/rugged-off-road-electric-scooter-terrain.jpg", "/all-terrain-electric-scooter.jpg"],
    category: "cat_4",
    specifications: {
      maxSpeed: "30 mph",
      range: "45 miles",
  ...
  },
  {
    ...
    price: 699,
    compareAtPrice: 849,
    images: ["/blue-electric-scooter-city-portable.jpg", "/foldable-electric-scooter.jpg"],
    category: "cat_2",
    specifications: {
      maxSpeed: "22 mph",
      range: "28 miles",
  ...
  },
  {
    ...
    price: 1999,
    compareAtPrice: 2399,
    images: ["/black-premium-electric-scooter-powerful.jpg", "/high-end-electric-scooter.jpg"],
    category: "cat_3",
    specifications: {
      maxSpeed: "40 mph",
      range: "50 miles",
